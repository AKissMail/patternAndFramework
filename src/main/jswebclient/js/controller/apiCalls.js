 ...
 * Connection Methode
 *
 * Diese Methode stellt einen Request an die Rest-Api. Es ergeben sich zwei Callbacks.
 * Bei erfolgreicher Ausführung wird die Antwort des Requests (Response)
 * in .done auf die Variable response geschrieben.
 *
 * @param path der URI-Pfad zur Api
