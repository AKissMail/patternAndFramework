...
export function show() {
    base.clearStage();
    document.getElementsByTagName("article")[0].appendChild(view.createButton("register", "Registrieren", "btn"));
    document.getElementsByTagName("article")[0].appendChild(view.createButton("logIn", "Log In", "btn"));
